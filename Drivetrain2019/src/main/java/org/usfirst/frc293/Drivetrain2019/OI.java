...
public class OI {
    ...
    public JoystickButton gripperTrigger;
    ...
    public OI() {
        ...
        gripperTrigger = new JoystickButton(opLeftJoystick, 1);
        gripperTrigger.whenPressed(new GripperOpen());
        ...
        SmartDashboard.putData("ElevatorPower", new ElevatorPower());
    ...
    gripperTrigger.whenReleased(new GripperClose());
